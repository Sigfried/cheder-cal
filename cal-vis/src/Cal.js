...
function getDates(jsDate) {
  const greg = getGregFromDate(jsDate)
  const jd = gregorian_to_jd(..._.at(greg,['year','month','day']))
  return {
      greg,
      jd
    }
...
class App extends Component {
  ...
  setGregCent(inp) {
    ...
    let dates = getDates(newDate)
    this.setState({jsDate:newDate, dates})
  }
